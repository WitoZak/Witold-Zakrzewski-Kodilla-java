...
class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("testListBooksInHandsOf")
    class testListBooksInHandsOf {
        @Test
        void testListZeroBookInHandsOf() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            List<Book> ListOf0Book = new ArrayList<>();
            LibraryUser libraryUser = new LibraryUser("John", "Dow", "123445669");
        ...
        void testListOneBookInHandsOf() {
            ...
            LibraryUser libraryUser = new LibraryUser("Mac", "Duck", "5465678987");
        ...
        void testListFiveBookInHandsOf() {
            ...
            LibraryUser libraryUser = new LibraryUser("Zak", "Kwak", "1356784566");
