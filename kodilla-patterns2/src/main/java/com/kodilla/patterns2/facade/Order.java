...
public class Order {
    ...
    private final List<Item> items = new ArrayList<>();  // '-'zamiast '='
    ...
    public Long getUserId() { return userId; } //brak ()

    public boolean isPaid() { return isPaid; } //brak ()
    ...
    public boolean isSubmitted() { return isSubmitted; } //literówka
